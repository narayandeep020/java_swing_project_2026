...
public class AboutUs extends JFrame {
    ...
    public AboutUs(){
        ...
        JLabel l6 = new JLabel("Developed By : Deep Narayan Lodhi");
        ...
        JLabel l9 = new JLabel("Facebook : @Deep_Narayan");
        l9.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
        l9.setBounds(99, 331, 600, 34);
        contentPane.add(l9);

        JLabel l10 = new JLabel("Github : https://github.com/narayandeep020");
